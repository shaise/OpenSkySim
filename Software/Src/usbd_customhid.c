...
static uint8_t report_desc_len;
...
void USBD_CUSTOM_HID_Update_desc_len(uint8_t ispnx)
{
  /* fill correct report descriptor length */
  report_desc_len = ispnx ? USBD_PNX_HID_REPORT_DESC_SIZE : USBD_SIM_HID_REPORT_DESC_SIZE;
  USBD_CUSTOM_HID_CfgFSDesc[25] = report_desc_len;
  USBD_CUSTOM_HID_CfgHSDesc[25] = report_desc_len;
  USBD_CUSTOM_HID_OtherSpeedCfgDesc[25] = report_desc_len;
  USBD_CUSTOM_HID_Desc[7] = report_desc_len;
}
    ...
    case USB_REQ_TYPE_STANDARD:
      switch (req->bRequest)
      {
        ...
        case USB_REQ_GET_DESCRIPTOR:
          ...
          {
            len = MIN(report_desc_len, req->wLength);

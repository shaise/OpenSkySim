...
uint8_t cc25xx_set_register(uint8_t reg, uint8_t val);
uint8_t cc25xx_get_register(uint8_t address);
uint8_t cc25xx_strobe(uint8_t val);
...
#define cc25xx_rx_sleep() { delay_us(1352); }
#define cc25xx_tx_sleep() { delay_us(1250); }
...
void cc25xx_process_packet(volatile uint8_t *packet_received,
